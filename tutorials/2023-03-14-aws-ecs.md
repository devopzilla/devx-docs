...
In this tutorial you'll use devx to generate Terraform IaC with security best-practices to run a workload on AWS.
...
2) You can package and re-use other types of configurations in devx modules e.g. CI pipelines, and application configurations

3) Nested configurations like the task definition are validated at generation
